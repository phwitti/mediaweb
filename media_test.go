...
func TestFullPath(t *testing.T) {
	// Root path
	media := createMedia(".", ".", true, false, false, true, false, 0, false, false, false)
	...
	// Relative path
	media = createMedia("arelative/path", ".", true, false, false, true, false, 0, false, false, false)
	p, err = media.getFullMediaPath("afile.jpg")
	assertExpectNoErr(t, "unable to get valid full path", err)
	...
	// Absolute path
	media = createMedia("/root/absolute/path", ".", true, false, false, true, false, 0, false, false, false)
	p, err = media.getFullMediaPath("afile.jpg")
	assertExpectNoErr(t, "unable to get valid full path", err)
...
func TestThumbnailPath(t *testing.T) {
	media := createMedia("/c/mediapath", "/d/thumbpath", true, false, false, true, false, 0, false, false, false)
...
func TestWriteThumbnail(t *testing.T) {
	...
	media := createMedia("testmedia", "tmpcache/TestWriteThumbnail", true, false, false, true, false, 0, false, false, false)
	...
	// Disable thumb cache
	media = createMedia("testmedia", "tmpcache/TestWriteThumbnail", false, false, false, true, false, 0, false, false, false)
...
func TestGenerateThumbnails(t *testing.T) {
	...
	media := createMedia("testmedia", cache, true, false, false, true, false, 0, false, false, false)
...
func TestGeneratePreviews(t *testing.T) {
	...
	media := createMedia("testmedia", cache, true, false, false, true, true, 1280, false, false, true)
...
func TestGenerateThumbnailsAndPreviews(t *testing.T) {
	...
	media := createMedia("testmedia", cache, true, false, false, true, true, 1280, false, false, false)
...
func TestGenerateAllThumbnails(t *testing.T) {
	...
	media := createMedia("testmedia", cache, true, true, false, true, false, 0, false, false, false)
...
func TestGenerateAllPreviews(t *testing.T) {
	...
	media := createMedia("testmedia", cache, true, false, false, true, true, 1280, true, false, false)
...
func TestGenerateAllThumbsAndPreviews(t *testing.T) {
	...
	media := createMedia("testmedia", cache, true, true, false, true, true, 1280, true, false, false)
...
func TestPreviewPath(t *testing.T) {
	media := createMedia("/c/mediapath", "/d/thumbpath", true, false, false, true, true, 1280, false, false, false)
...
func TestGenerateImagePreview(t *testing.T) {
	...
	media := createMedia("", "", true, false, false, true, true, 1280, false, false, false)
...
func TestWritePreview(t *testing.T) {
	...
	media := createMedia("testmedia", "tmpcache/TestWritePreview", true, false, false, true, true, 970, false, false, false)
	...
	// Disable preview
	media = createMedia("testmedia", "tmpcache/TestWritePreview", false, false, false, true, false, 0, false, false, false)
