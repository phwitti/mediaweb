...
func TestWatcherImages(t *testing.T) {
	...
	media := createMedia(mediaPath, cache, true, false, false, true, true, false, 0, false, false, false, true)
...
func TestWatcherFileLocked(t *testing.T) {
	...
	media := createMedia(mediaPath, cache, true, false, false, true, true, false, 0, false, false, false, false)
	defer media.watcher.stopWatcherAndWait()
